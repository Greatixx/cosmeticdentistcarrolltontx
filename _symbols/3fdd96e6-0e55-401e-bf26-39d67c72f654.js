// Site Header - Updated November 1, 2023
function noop() { }
const identity = x => x;
...
function create_each_block_1(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "link svelte-1x8qhea");
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			...
			attr(button, "class", "svelte-1x8qhea");
			attr(nav, "id", "popup");
			attr(nav, "class", "svelte-1x8qhea");
		},
		m(target, anchor) {
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(a0, "href", "/");
			attr(a0, "class", "logo svelte-1x8qhea");
			attr(nav, "class", "svelte-1x8qhea");
			attr(div0, "class", "desktop-nav svelte-1x8qhea");
			attr(a1, "href", "/");
			attr(a1, "class", "logo svelte-1x8qhea");
			attr(button, "id", "open");
			attr(button, "aria-label", "Open mobile navigation");
			attr(div1, "class", "mobile-nav svelte-1x8qhea");
			attr(div2, "class", "section-container svelte-1x8qhea");
			attr(h1, "class", "headline svelte-1x8qhea");
			attr(div3, "class", "section-container svelte-1x8qhea");
			...
			attr(header, "class", "svelte-1x8qhea");
